...
public enum FStrings {
    ...
    private static let table: [String: [String: String]] = [
        ...
        "zh": [
            ...
            // reach for - 盖牌 to cover, 收牌 to take the table, 过 for “I am done” -
            ...
            "ios.rej.defending": "你在防守 - 盖住这次进攻，或者把牌收走。",
            ...
            "ios.rules.defend.b": "带盾图标、正在被进攻的那位玩家是防守方。同一时刻只会有一个防守方，别人打到桌上的牌都要由他来应对。防守方只能盖牌、收牌，或者转移（如果这一桌允许）。防守方不能自己进攻。其他所有人都是进攻方，只能进攻，不能去盖桌上的牌。",
            "ios.rules.defend.b.nopass": "带盾图标、正在被进攻的那位玩家是防守方。同一时刻只会有一个防守方，别人打到桌上的牌都要由他来应对。防守方只能盖牌或者收牌。防守方不能自己进攻。其他所有人都是进攻方，只能进攻，不能去盖桌上的牌。",
            ...
            "ios.rules.pickup.h": "收牌",
            "ios.rules.pickup.b": "如果防守方盖不住所有的牌，或者不想盖，可以按收牌按钮。这样桌上所有的牌都会进他的手里，已经被盖住的也一样。而且他这一轮会被跳过，下一轮由他左边的人开始进攻。所以要不要收牌，得想清楚。",
            "ios.rules.pickup.cap": "这里收牌的话，三张牌都进你手里 - 那对盖住的也一样。",
            "ios.rules.round.h": "一轮结束",
            "ios.rules.round.b": "当桌上所有牌都被盖住，而且所有进攻方都表示不再加牌时，桌上的牌全部进弃牌堆。然后从首攻开始，顺时针轮到每一位进攻方补牌，补到至少 6 张为止，最后才轮到防守方补牌。这些都由游戏自动完成。牌堆摸完之后，大家就可以开始清手里的牌，争取不做最后那个傻瓜。防守方选择收牌时，这一轮同样结束，进攻方也照样补牌。",
            "ios.rules.pass.h": "转移",
            ...
            "ios.tut_2": "进攻时点一下手里的牌。对手必须盖住它 - 否则就得把牌全收走。",
            "ios.tut_3": "防守时先点你的一张牌，再点它要盖的那次进攻。同花色更大的牌，或者任意一张主牌，都能盖住。",
            "ios.tut_4": "盖不住或者不想盖？点“收牌”把桌上的牌收走。不想再进攻了？点“过”。",
