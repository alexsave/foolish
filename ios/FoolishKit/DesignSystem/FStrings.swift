...
public enum FStrings {
    ...
    private static let table: [String: [String: String]] = [
        "en": [
            ...
            "lobby": "Lobby", "game_code": "Game code", "add_bot": "Add bot",
            "add_bot_named": "Add {name}", "join": "Join", "joining": "Joining…",
            "join_code_prompt": "Enter a game code",
            "add_bot_hint": "Add at least one opponent to start.",
        ...
        "ru": [
            ...
            "lobby": "Лобби", "game_code": "Код игры", "add_bot": "Добавить бота",
            "add_bot_named": "Добавить {name}", "join": "Войти", "joining": "Вход…",
            "join_code_prompt": "Введите код игры",
            "add_bot_hint": "Добавьте хотя бы одного соперника.",
        ...
        "ko": [
            ...
            "lobby": "대기실", "game_code": "게임 코드", "add_bot": "봇 추가",
            "add_bot_named": "{name} 추가", "join": "참가", "joining": "참가 중…",
            "join_code_prompt": "게임 코드 입력",
            "add_bot_hint": "시작하려면 상대를 한 명 이상 추가하세요.",
