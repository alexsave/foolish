...
public enum FStrings {
    ...
    private static let table: [String: [String: String]] = [
        "en": [
            ...
            "ios.msg.yourmove": "Your move", "ios.msg.staged": "Move staged — hit Send",
            "ios.msg.waiting": "Waiting for the others", "ios.msg.waitingfor": "Waiting for {name}",
            "ios.msg.send": "Send move", "ios.msg.sending": "Sending…", "ios.msg.undo": "Undo",
            "ios.msg.newgame": "New game", "ios.msg.pickseat": "Which player are you?",
            "ios.msg.thread": "A game in this thread", "ios.msg.tap": "Durak — tap to play",
            "ios.msg.damaged": "This game link is damaged.", "ios.msg.open": "Open the game",
            "ios.tut_next": "Got it",
        ...
        "ru": [
            ...
            "ios.msg.yourmove": "Ваш ход", "ios.msg.staged": "Ход готов — нажмите «Отправить»",
            "ios.msg.waiting": "Ждём других игроков", "ios.msg.waitingfor": "Ждём: {name}",
            "ios.msg.send": "Отправить ход", "ios.msg.sending": "Отправка…", "ios.msg.undo": "Отменить",
            "ios.msg.newgame": "Новая игра", "ios.msg.pickseat": "Кто вы из игроков?",
            "ios.msg.thread": "Игра в этой переписке", "ios.msg.tap": "Дурак — нажмите, чтобы играть",
            "ios.msg.damaged": "Ссылка на игру повреждена.", "ios.msg.open": "Открыть игру",
        ...
        "ko": [
            ...
            "ios.you": "나",
            "ios.nobattle": "전투 없음",
            "ios.msg.yourmove": "당신 차례", "ios.msg.staged": "수 준비됨 — 전송하세요",
            "ios.msg.waiting": "다른 플레이어 대기 중", "ios.msg.waitingfor": "{name} 대기 중",
            "ios.msg.send": "수 보내기", "ios.msg.sending": "보내는 중…", "ios.msg.undo": "취소",
            "ios.msg.newgame": "새 게임", "ios.msg.pickseat": "당신은 어느 플레이어인가요?",
            "ios.msg.thread": "이 대화의 게임", "ios.msg.tap": "두락 — 탭하여 플레이",
            "ios.msg.damaged": "게임 링크가 손상되었습니다.", "ios.msg.open": "게임 열기",
            "ios.tut_next": "알겠어요",
            "ios.tut_done": "게임 시작",
