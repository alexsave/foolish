...
//
//   cnitro/tests/msg_wire_test.c   the native kernel SEALS them (--fixture)
...
// `cnitro/build/msg_wire_test --fixture` only when the WIRE deliberately
...
final class MessageEnvelopeTests: XCTestCase {
    ...
    private let fixtures: [Fixture] = [
        .init(players: 2, turn: 7, round: 1, hex:
        ...
        .init(players: 4, turn: 5, round: 1, hex:
