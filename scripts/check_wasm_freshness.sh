...
ARTIFACTS=(
  ...
  # Generated by the same targets and checked against each module at load
...
for entry in "${ARTIFACTS[@]}"; do
  ...
  case "$path" in sdk/ts/gen/*)
    printf '  content  %-30s stamped; regenerated text checked by tools/structgen/gen.sh --check\n' "$path"
    continue ;;
  esac
