                ...
                <TextureProvider>
                  ...
                  <AuthProvider>
                    <ErrorBoundary context="Auth Provider">
                      {/* The kernel gate is NOT here. It used to wrap these
                          children, which meant it wrapped every route that
                          would ever exist - and a gated route prerenders to
                          nothing but the <noscript> line, which is right for a
                          game surface and blank for a page meant to be read.
                          It now lives on the routes that run the kernel; see
                          components/KernelGate.tsx. This boundary still catches
                          the throw when the wasm will not load. */}
