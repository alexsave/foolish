...
export const strings_en: Record<StringId, string> = {
  ...
  username_reserved: 'That username is reserved. Usernames can’t contain the \u{1F916} symbol.',
...
export const strings_ru: Record<StringId, string> = {
  ...
  username_reserved: 'Это имя пользователя зарезервировано. Имя не может содержать символ \u{1F916}.',
...
export const strings_ko: Record<StringId, string> = {
  ...
  login_failed: '로그인 실패',
  signup_failed: '가입 실패',
  username_reserved: '사용할 수 없는 사용자 이름입니다. 이름에 \u{1F916} 기호를 포함할 수 없습니다.',
