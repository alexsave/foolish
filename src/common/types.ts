...
export interface PublicGame {
    ...
    good_timestamp: number | null; // Timestamp when all attacks were covered, starting the 'good' countdown
    good_players: string[]; // Array of player_ids who have pressed 'good' this round
}
