 ...
 * It is blind to one thing: the host moves its whole card 6.7 points when
 * the drawer changes style (913 compact, 919.67 expanded on a 956-point
 * phone), the content with it, which scores here as a step. Score a take
 * both ways: the painted bar misses content that jumped with it, this
 * counts the card's shift.
