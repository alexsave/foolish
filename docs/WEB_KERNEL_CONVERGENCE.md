...
> **Dated measurement, 2026-09-06.** The line counts below were taken against `origin/main` on
> that date. Several of the duplications it measures have since been removed, so read the
> numbers as the state of the question when it was asked, not as the current balance.
