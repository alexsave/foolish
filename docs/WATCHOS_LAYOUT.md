...
|---|----------|----------------------|-----------|
| 1 | Deck composition | 2–5 players: 36 cards (ranks 6–A). **6–8 players: full 52** (ranks 2–A). One of each suit/rank; hands deal & refill to 6. An 8-seat game deals 48 and flips one — the stock is **3 + the flip** and dies in about a round. | `sdk/c/src/card.h:15-29`, `constants.ts:33-39`, `card.h:25` |
