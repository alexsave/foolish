...
`c/tests/l1_measure.c` plays **~63,000 real engine games** — every player
...
Reproduce the floor vs infinite: `c/tools/tt_divergence.sh octogen handwritten 2,4,6,8 4000 99 16 13 11 9 7`.
Reproduce vs production: `BASE=16 c/tools/tt_divergence.sh octogen handwritten 4 800 99001 13` (expect 0).
