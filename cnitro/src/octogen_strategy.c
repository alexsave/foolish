...
// ---------- OG_EXPLAIN: deliberation dump (runtime-gated, zero-cost off) ----
//
// Set OG_EXPLAIN=1 (dump to stderr) or OG_EXPLAIN=/path/to/file (dump to a
// file) to emit one JSON-lines record per deciding-seat decision: the seat's
// hand, the table, the candidate moves with their MC average-finish scores
...
// typedef, just above octogen_strategy_choose.
