 ...
 * normal bridge; N worker threads deliberate in parallel over the shared state
 * and fold their per-candidate rollout scores into g_ogmt with C atomics (the
 * MT5 hook lives in octogen_strategy.c). No per-batch JSON, no postMessage.
 * ========================================================================== */
