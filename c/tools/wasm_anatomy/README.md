...
```bash
c/tools/wasm_anatomy/generate.sh          # -> docs/wasm-anatomy.html
c/tools/wasm_anatomy/generate.sh out.html # custom output path
```
...
```bash
c/tools/wasm_anatomy/wasm-anatomy.sh app.wasm            # -> wasm-anatomy.html
c/tools/wasm_anatomy/wasm-anatomy.sh a.wasm b.wasm \
