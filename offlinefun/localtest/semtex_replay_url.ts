...
//
// The encoded game is verified with verifyRoundTripV6FromGame before printing,
// so the URL is guaranteed to decode on the site - the same one kernel call the
// server makes at game end.
