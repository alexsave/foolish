...
| 6 | Doctor from Oxford | quill@60 | 1205 | 293 | 1.8 |
| 7 | Professor from Cambridge | fountain@2500 | 1779 | 574 | 59 |

The top gap is the wide one, and at 98-100% scores the fit cannot resolve it finely anyway.
If it should be narrower, quill@200 sits about 175 Elo above quill@60 (a 60-game side ladder) and would make the top two gaps roughly 470 and 400; nothing between quill@200 and fountain@2500 is worth a name.
...
- fountain@2500 costs about 50-60 ms a move on an M-series Mac, a little less than quill@4000, and is the strongest engine there is; quill@60 sits halfway between roller@200 and it.
