...
static void cd_sample_world(Game *g_out, const Game *g_in, int my_idx,
    ...
    // CD_FULL_LOGS (research, bp-style worlds) needs the whole log array —
    ...
    if (cd_full_logs && WORLD_LOG_CAP == 0) {
...
// (sdk/c/LEAFBOOK.md) — a proven-exact, strength-neutral speedup shared with
