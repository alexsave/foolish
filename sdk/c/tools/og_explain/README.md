...
```sh
python3 sdk/c/tools/og_explain/explain.py "<replay-url>" "<deal-seed>" [out.html]
```

Example (defaults to `docs/octogen-replay-explain.html`):

```sh
python3 sdk/c/tools/og_explain/explain.py \
...
2. **`make og_explain`** — builds `sdk/c/tests/og_explain.c` with
