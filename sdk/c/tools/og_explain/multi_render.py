...
<code>-DOG_EXPLAIN_BUILD</code>, absent from shipped bots) in <code>sdk/c/src/octogen_strategy.c</code>; game driven
through the deployed wasm by <code>e2e/_wasm_multi_drive.test.ts</code>; page assembled by
<code>sdk/c/tools/og_explain/multi_page.py</code>.</p>
</div>
<script>
const DATA=__DATA__;
</script>
