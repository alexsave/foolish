...
<code>-DOG_EXPLAIN_BUILD</code>, absent from shipped bots) in <code>sdk/c/src/octogen_strategy.c</code>;
game reproduced and driven by <code>sdk/c/tests/og_explain.c</code>; page assembled by
<code>sdk/c/tools/og_explain/</code>.</p>
</div>
<script>
const DATA=__DATA__;
</script>
