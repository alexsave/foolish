import { Card, Game, AnimationEvent, GAME_STATUS } from '@api/core/types.ts';
import { verify_card_array, cardDisplay } from '@api/common/common_utils.ts';
import { kernelCover, kernelValidateCover } from '@sdk/ts/wasm/engine.ts';

// The cover rules live in the C kernel (c/src/game.c handle_cover),
