            ...
            if (Object.values(GAME_MOVE_TYPE).includes(message.type as GameMoveType)) {
                ...
                if (message.type === GAME_MOVE_TYPE.COVER) {
                    ...
                    if (game.players[game.currentlyAttacked].id !== player_id) {
                        throw new Error(`Player ${player_id} is not the defender, cannot cover`);
                    }
                    ...
                    // check if player is the defender
                    if (game.players[game.currentlyAttacked].id !== player_id) {
                        throw new Error(`Player ${player_id} is not the defender, cannot pick up`);
                    }
                    ...
                    if (game.players[game.currentlyAttacked].id !== player.id) {
                        throw new Error(`Player ${player_id} is not the defender, cannot pass`);
                    }
                    ...
                    if (game.players[game.currentlyAttacked].id === player.id) {
                        throw new Error(`Player ${player_id} is the defender and cannot attack`);
                    }
